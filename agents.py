...
#         }
# Old OpenAI Implementation (Commented out)
# llm = ChatOpenAI(model="gpt-4", temperature=0)

# --- MODIFIED FOR DEEPSEEK R1 INTEGRATION ---
...
print(f"✅ Monitor Agent initialized with {llm.model_name}...")
print("🔄 Loading Long-chain reasoning context...")
